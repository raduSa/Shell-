...
static const YYINT yydefred[] = {                         1,
    0,    0,    9,    4,    2,    0,    6,    5,    0,    0,
    0,   10,    7,    0,    0,    0,    0,   18,    0,   12,
   13,   14,   15,   16,    3,
};
#if defined(YYDESTRUCT_CALL) || defined(YYSTYPE_TOSTRING)
static const YYINT yystos[] = {                           0,
  267,  256,  257,  265,  268,  269,  272,  265,  273,  263,
  270,  257,  272,  258,  259,  260,  261,  264,  271,  274,
  257,  257,  257,  257,  265,
};
...
static const YYINT yysindex[] = {                         0,
 -256, -263,    0,    0,    0, -260,    0,    0, -240, -239,
 -237,    0,    0, -232, -231, -229, -228,    0, -261,    0,
    0,    0,    0,    0,    0,
};
static const YYINT yyrindex[] = {                         0,
    0,    0,    0,    0,    0, -245,    0,    0, -253,    0,
...
static const YYINT yytable[] = {                          2,
    3,    8,   10,   25,    8,    8,    8,    8,    4,    8,
    8,    8,   11,   11,   11,   11,   12,    3,   11,   11,
   14,   15,   16,   17,   21,   22,   18,   23,   24,   17,
   13,
};
static const YYINT yycheck[] = {                        256,
  257,  265,  263,  265,  258,  259,  260,  261,  265,  263,
  264,  265,  258,  259,  260,  261,  257,  257,  264,  265,
  258,  259,  260,  261,  257,  257,  264,  257,  257,  265,
   10,
};
#if YYBTYACC
...
"GREATGREAT","GREATAMPERSAND","GREATGREATAMPERSAND","PIPE","AMPERSAND",
"NEWLINE","$accept","command_list","command_line","pipe_list",
"io_modifier_list","background_optional","cmd_and_args","arg_list",
"io_modifier","illegal-symbol",
};
